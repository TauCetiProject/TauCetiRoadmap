...
16. [Operator theory (polar decomposition, majorization, principal angles, operator ideals, spectral-subspace perturbation)](TauCetiRoadmap/OperatorTheory/README.md)
17. [Berge's maximum theorem](TauCetiRoadmap/BergeMaximumTheorem/README.md)
