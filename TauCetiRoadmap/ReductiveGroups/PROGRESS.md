...
<!--tauceti-progress:v1 {"from_sha":"6777fc49b6a67b3b0849e5d18bc0395b6f1450c3","prs":[4691,4700,4987,5000,5543,5560,5563,5565,5623,5667,5675,5677,5693,5694,5702,5719,5725,5736,5739,5748,5758,5761,5769,5785,5788,5834,5889,5915,5918,5920,5947,5986,5990,5996,6024,6037,6041,6059,6075],"roadmap":"ReductiveGroups","to_sha":"15859e1a6e7a78c98096949403e0831c8dd6e269"}-->
## ReductiveGroups: 2026-09-04 to 2026-09-08 (`6777fc4` to `15859e1`)

General structure theory gained two existence theorems: [every finite-type affine group over a field has a maximal torus](https://taucetiproject.github.io/TauCeti/docs/TauCeti/Algebra/AlgebraicGroup/Torus/Existence.html#TauCeti.HopfIdeal.exists_isMaximalTorus), and [its geometric fibre has a Borel subgroup](https://taucetiproject.github.io/TauCeti/docs/TauCeti/Algebra/AlgebraicGroup/Borel/Existence.html#TauCeti.HopfIdeal.exists_geometricBorel). Lie–Kolchin also reached a precise conditional form: when the derived closed subgroup is geometrically unipotent, every finite-dimensional comodule admits [an upper-triangular basis with characters on the diagonal](https://taucetiproject.github.io/TauCeti/docs/TauCeti/Algebra/AlgebraicGroup/Solvable/LieKolchin.html#TauCeti.Comodule.exists_basis_coefficientMatrix_isUpperTriangular_of_geometricallyUnipotent_derived). The missing step is still the general passage from solvability to that hypothesis.

The foundational smoothness comparison is now exact: for finite-type commutative Hopf algebras over a field, [smoothness is equivalent to geometric reducedness](https://taucetiproject.github.io/TauCeti/docs/TauCeti/Algebra/AlgebraicGroup/Smooth/GeometricallyReduced.html#TauCeti.smoothCommHopfAlgProperty_iff_geometricallyReduced). Among the worked examples, [the standard symplectic group is reductive over every field](https://taucetiproject.github.io/TauCeti/docs/TauCeti/Algebra/AlgebraicGroup/Symplectic/Reductive.html#TauCeti.Symplectic.reductiveCommHopfAlgProperty_finiteTypeCoordinateHopfAlgebra); the corresponding orthogonal development currently proves complete reducibility only for the standard representation in dimension at least three and characteristic different from two.

The pinned integral lane acquired [the characteristic-two special isogeny of `Sp₄`, whose square is Frobenius](https://taucetiproject.github.io/TauCeti/docs/TauCeti/LinearAlgebra/Matrix/GeneralLinearGroup/Symplectic/SpecialIsogeny.html#TauCeti.specialIsogeny_comp_specialIsogeny), together with Frobenius-compatible torus maps for types `B₂`, `F₄`, and `G₂` and a [fixed-point description for the type-`D` spin carrier](https://taucetiproject.github.io/TauCeti/docs/TauCeti/Algebra/Lie/Orthogonal/TypeD/SpinCarrier/FixedPoints.html#TauCeti.TypeDSpinCarrier.pointsMulEquivFixedSubgroupFrobenius). These are still type-specific pieces, not the uniform pinned Chevalley–Demazure construction or its isomorphism theorem.
