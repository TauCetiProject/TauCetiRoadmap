...
<!--tauceti-progress:v1 {"from_sha":"c4d7989a116c565aa558fb82c318ad7c651bf2f4","prs":[3548,3604,3631,3663,3677,3712,3741,3748,3753,3757,3758,3761,3774,3777,3778,3786,3788,3791,3798,3799,3801,3814,3821,3825,3826,3827,3835,3841,3842,3843,3847,3848,3851,3856,3858,3860,3873,3874,3876,3890,3893,3911,3917,3922,3925,3927,3931,3933,3934,3936,3938,3939,3940,3942,3943,3951,3952,3958,3968,3970,3973,3975,3978,3979,3984,3989,3992,4032,4035,4046,4062,4067,4073,4077,4082,4089,4093,4098,4104,4111,4112,4113,4115,4121,4127,4130,4139,4145,4152,4154,4159,4185,4200,4215,4225,4228,4230,4236,4240,4251,4253,4263,4266,4277,4290,4293,4298,4303,4305,4317,4321,4323,4327,4337,4342,4347,4357,4359,4361,4363,4375,4388,4393,4394,4396,4398,4403,4416,4434,4436,4440,4441,4442,4451,4456,4470,4474,4477,4480,4489,4493,4502,4527,4536,4561,4577,4579,4580,4581,4583,4585,4587,4588,4591,4598,4605,4614,4620,4625,4636,4647,4661,4666,4674,4687,4695,4698,4707,4724,4734,4742,4746,4747,4752,4754,4756,4761,4768,4779,4784],"roadmap":"ReductiveGroups","to_sha":"cfd9d5022bdb2bbda7118e7ee8cc6adfab7a2d72"}-->
## ReductiveGroups: 2026-08-18 to 2026-08-27 (`c4d7989` to `cfd9d50`)

The first genuinely reductive examples are now in place: [the general linear group](https://taucetiproject.github.io/TauCeti/docs/TauCeti/Algebra/AlgebraicGroup/GeneralLinear/Reductive.html#TauCeti.GeneralLinear.reductiveCommHopfAlgProperty_finiteTypeCoordinateHopfAlgebra), [the special linear group](https://taucetiproject.github.io/TauCeti/docs/TauCeti/Algebra/AlgebraicGroup/SpecialLinear/Reductive.html#TauCeti.SpecialLinear.reductiveCommHopfAlgProperty_finiteTypeCoordinateHopfAlgebra), and [every torus](https://taucetiproject.github.io/TauCeti/docs/TauCeti/Algebra/AlgebraicGroup/Torus/Reductive.html#TauCeti.torusCommHopfAlgProperty.reductive) are reductive over arbitrary fields. On the representation-theoretic side, [Kolchin’s fixed-vector theorem for the additive group](https://taucetiproject.github.io/TauCeti/docs/TauCeti/Algebra/AlgebraicGroup/AdditiveGroup/Unipotent.html#TauCeti.AdditiveGroup.exists_ne_zero_coact_eq_tmul_one) holds over an arbitrary base without a finiteness assumption, while [the additive group is not linearly reductive](https://taucetiproject.github.io/TauCeti/docs/TauCeti/Algebra/AlgebraicGroup/AdditiveGroup/LinearlyReductive.html#TauCeti.AdditiveGroup.not_isLinearlyReductive) over any field.

The dynamic approach to structure theory produced [the functorial Levi decomposition](https://taucetiproject.github.io/TauCeti/docs/TauCeti/Algebra/AlgebraicGroup/Dynamic/LeviDecomposition/Naturality.html#TauCeti.Cocharacter.leviDecompositionNatIso): a cocharacter’s dynamic parabolic is naturally the semidirect product of its unipotent and Levi subgroup functors. For `GLₙ`, the diagonal torus now carries [its coordinate root datum](https://taucetiproject.github.io/TauCeti/docs/TauCeti/Algebra/AlgebraicGroup/GeneralLinear/Root/Datum.html#TauCeti.GeneralLinear.diagonalRootDatum), and [its normalizer quotient is the corresponding Weyl group](https://taucetiproject.github.io/TauCeti/docs/TauCeti/Algebra/AlgebraicGroup/GeneralLinear/Root/WeylGroup.html#TauCeti.GeneralLinear.diagonalNormalizerQuotientMulEquivWeylGroup). This remains type-A structure theory: general maximal tori, Borels, root data and Bruhat decomposition are not established.

The unipotent-radical construction is still incomplete. There is [a candidate of maximal Lie dimension](https://taucetiproject.github.io/TauCeti/docs/TauCeti/Algebra/AlgebraicGroup/Unipotent/Radical/Basic.html#TauCeti.HopfIdeal.exists_isUnipotentRadicalCandidate_maximal_finrank_quotientLie), and candidates are closed under suitable products, but no declaration yet proves that one is maximal by inclusion or names it as the unipotent radical.
