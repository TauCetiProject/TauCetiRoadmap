...
<!--tauceti-progress:v1 {"from_sha":"e7f4d8372f5a7ad39a75e61b43864f16d1bb57a0","prs":[5382,6045,6048,6070,6104,6112,6119,6132,6134,6136,6141,6150,6157,6160,6169,6186,6187,6192,6204,6225,6227,6283,6307,6317,6337,6341,6356,6364,6375,6385,6408,6420,6424],"roadmap":"ReductiveGroups","to_sha":"37aec57229a4a5828884027165b25804aac01ac8"}-->
## ReductiveGroups: 2026-09-09 to 2026-09-12 (`e7f4d83` to `37aec57`)

Every standard special orthogonal group is now [reductive over a field of characteristic different from two](https://taucetiproject.github.io/TauCeti/docs/TauCeti/Algebra/AlgebraicGroup/SpecialOrthogonal/Reductive.html#TauCeti.SpecialOrthogonal.reductiveCommHopfAlgProperty_finiteTypeCoordinateHopfAlgebra), in every dimension. This closes the previous rank-zero-and-one gap: the coordinate Hopf algebra is [geometrically connected](https://taucetiproject.github.io/TauCeti/docs/TauCeti/Algebra/AlgebraicGroup/SpecialOrthogonal/Connected.html#TauCeti.SpecialOrthogonal.geometricallyConnectedCommHopfAlgProperty_coordinateHopfAlgebra), while Cartan–Dieudonné supplies [generation by products of two reflections](https://taucetiproject.github.io/TauCeti/docs/TauCeti/LinearAlgebra/QuadraticForm/CartanDieudonne/SpecialOrthogonal.html#TauCeti.QuadraticMap.closure_reflection_mul_eq_specialOrthogonalGroup). Characteristic two is not covered.

Structure theory gained several useful bridges: [the diagonal torus of the symplectic group is maximal over every field](https://taucetiproject.github.io/TauCeti/docs/TauCeti/Algebra/AlgebraicGroup/Symplectic/DiagonalTorus/Maximal.html#TauCeti.Symplectic.isMaximalTorus_diagonalTorusDefiningIdeal), and the derived subgroup of a connected finite-type affine group over an algebraically closed field is [geometrically connected](https://taucetiproject.github.io/TauCeti/docs/TauCeti/Algebra/AlgebraicGroup/Derived/Connected.html#TauCeti.CommHopfAlgCat.geometricallyConnectedCommHopfAlgProperty_derived). In the explicit Chevalley lane, [Weyl-word representatives act on the represented weight torus by the corresponding reflections](https://taucetiproject.github.io/TauCeti/docs/TauCeti/LinearAlgebra/RootSystem/SimplyConnectedRootDatum/GeckLattice/Weyl.html#TauCeti.DynkinType.geckWeylWordPoint_conj_geckWeightTorusPoints), the short-pair `G₂` commutator relation reached Kostant root-subgroup points, and [type-B carrier points fixed by Frobenius are identified with points over the fixed subring](https://taucetiproject.github.io/TauCeti/docs/TauCeti/Algebra/Lie/Orthogonal/TypeB/SpinCarrier/FixedPoints.html#TauCeti.TypeBSpinCarrier.pointsMulEquivFixedSubgroupFrobenius). These remain typewise constructions, not a uniform pinned Chevalley–Demazure group scheme.
