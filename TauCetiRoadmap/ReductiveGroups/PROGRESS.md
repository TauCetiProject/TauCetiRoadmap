...
<!--tauceti-progress:v1 {"from_sha":"c4d7989a116c565aa558fb82c318ad7c651bf2f4","prs":[3548,3604,3631,3663,3677,3712,3741,3748,3753,3757,3758,3761,3774,3777,3778,3786,3788,3791,3798,3799,3801,3814,3821,3825,3826,3827,3835,3841,3842,3843,3847,3848,3851,3856,3858,3860,3873,3876,3890,3911,3917,3922,3925,3927,3931,3933,3934,3936,3938,3939,3940,3942,3943,3951,3952,3958,3968,3970,3973,3975,3978,3979,3984,3989,3992,4032,4035,4046,4062,4067,4073,4077,4082,4093,4104,4113],"roadmap":"ReductiveGroups","to_sha":"629fa9824c89686bcdafae2adb2a9c4d74a142de"}-->
## ReductiveGroups: 2026-08-18 to 2026-08-21 (`c4d7989` to `629fa98`)

The geometric definition of unipotence now has its expected linear form: a reduced finite-type affine group over an algebraically closed field is unipotent exactly when it admits a closed immersion into some upper-unitriangular group ([`geometricallyUnipotentPointsCommHopfAlgProperty.iff_exists_isClosedImmersion_upperUnitriangularGroupScheme`](https://taucetiproject.github.io/TauCeti/docs/TauCeti/Algebra/AlgebraicGroup/Unipotent/Embedding.html#TauCeti.geometricallyUnipotentPointsCommHopfAlgProperty.iff_exists_isClosedImmersion_upperUnitriangularGroupScheme)). This gives the first substantive reductivity example as well: [every torus over a field is reductive](https://taucetiproject.github.io/TauCeti/docs/TauCeti/Algebra/AlgebraicGroup/Torus/Reductive.html#TauCeti.torusCommHopfAlgProperty.reductive), in arbitrary characteristic. The unipotent radical itself is not yet constructed; what exists is a connected normal smooth unipotent subgroup of maximal Lie dimension ([`exists_isUnipotentRadicalCandidate_maximal_finrank_quotientLie`](https://taucetiproject.github.io/TauCeti/docs/TauCeti/Algebra/AlgebraicGroup/Unipotent/Radical/Basic.html#TauCeti.HopfIdeal.exists_isUnipotentRadicalCandidate_maximal_finrank_quotientLie)), not a proof of maximality by inclusion.

The structure-theory lanes also became concrete. Affine groups now have represented [centers](https://taucetiproject.github.io/TauCeti/docs/TauCeti/Algebra/AlgebraicGroup/Center/Basic.html#TauCeti.CommHopfAlgCat.centerGroupScheme) and [derived subgroups](https://taucetiproject.github.io/TauCeti/docs/TauCeti/Algebra/AlgebraicGroup/Derived/Basic.html#TauCeti.CommHopfAlgCat.derivedGroupScheme), while the component quotient over the algebraically closed setting is represented by the finite constant group scheme of connected components ([`componentGroupFppfGroupObjectIso`](https://taucetiproject.github.io/TauCeti/docs/TauCeti/Algebra/AlgebraicGroup/Connected/ComponentGroup/Representable.html#TauCeti.FiniteTypeCommHopfAlgCat.componentGroupFppfGroupObjectIso)). A cocharacter now defines pointwise dynamic parabolic, Levi and unipotent subgroups, with a unique [dynamic Levi decomposition](https://taucetiproject.github.io/TauCeti/docs/TauCeti/Algebra/AlgebraicGroup/Dynamic/Parabolic.html#TauCeti.Cocharacter.exists_mem_unipotent_mem_levi); representability and the general Borel–root-data theory remain open.
