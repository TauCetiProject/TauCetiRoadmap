...
<!--tauceti-progress:v1 {"from_sha":"e7f4d8372f5a7ad39a75e61b43864f16d1bb57a0","prs":[5382,6045,6048,6070,6104,6112,6119,6132,6134,6136,6141,6150,6157,6160,6169,6186,6187,6192,6204,6225,6227,6283,6307,6317,6337,6341],"roadmap":"ReductiveGroups","to_sha":"94050b6aee7bc349e209c85bf5e2cec3c49420a8"}-->
## ReductiveGroups: 2026-09-09 to 2026-09-11 (`e7f4d83` to `94050b6`)

Every standard special orthogonal group is now reductive over a field of characteristic different from two ([`reductiveCommHopfAlgProperty_finiteTypeCoordinateHopfAlgebra`](https://taucetiproject.github.io/TauCeti/docs/TauCeti/Algebra/AlgebraicGroup/SpecialOrthogonal/Reductive.html#TauCeti.SpecialOrthogonal.reductiveCommHopfAlgProperty_finiteTypeCoordinateHopfAlgebra)). This closes the former dimension gap: pairs of reflections generate the special orthogonal group and admit Laurent-polynomial paths to the identity ([`exists_laurentPath_reflectionMatrix_mul`](https://taucetiproject.github.io/TauCeti/docs/TauCeti/LinearAlgebra/Matrix/SpecialOrthogonalGroup/Reflection.html#TauCeti.exists_laurentPath_reflectionMatrix_mul)), while the unipotent radical is trivial in dimensions at least three; dimension two is handled as a split torus. Characteristic two is not covered.

The surrounding structure theory also became more usable. The center now commutes with field extension ([`centerCoordinateBaseChangeIso`](https://taucetiproject.github.io/TauCeti/docs/TauCeti/Algebra/AlgebraicGroup/Center/BaseChange.html#TauCeti.CommHopfAlgCat.centerCoordinateBaseChangeIso)), and over a Noetherian base the kernel of a central isogeny is packaged as a finite locally free bicommutative Hopf algebra ([`kernelFiniteLocallyFree`](https://taucetiproject.github.io/TauCeti/docs/TauCeti/Algebra/AlgebraicGroup/Isogeny/Kernel.html#TauCeti.CommHopfAlgCat.IsCentralIsogeny.kernelFiniteLocallyFree)). Smooth geometrically connected affine groups now have torsion-free character lattices ([`isMulTorsionFree_geometricCharacterGroup_of_smooth`](https://taucetiproject.github.io/TauCeti/docs/TauCeti/Algebra/AlgebraicGroup/CommHopfAlgCat/CharacterLattice/Torsion.html#TauCeti.CommHopfAlgCat.isMulTorsionFree_geometricCharacterGroup_of_smooth)).

In the integral Chevalley lane, the type-`G₂` short-pair relation was carried from divided-power normal ordering through exponentials to represented Kostant root subgroups ([`schemePointsMulEquiv_kostantRootSubgroup_mul_of_g2_short_pair`](https://taucetiproject.github.io/TauCeti/docs/TauCeti/Algebra/Lie/UniversalEnveloping/Kostant/RootSubgroup/Scheme/Relations/G2/ShortPair.html#TauCeti.UniversalEnvelopingAlgebra.schemePointsMulEquiv_kostantRootSubgroup_mul_of_g2_short_pair)). For the type-`B` spin carrier, Frobenius-fixed points are identified with points over the fixed subring ([`pointsMulEquivFixedSubgroupFrobenius`](https://taucetiproject.github.io/TauCeti/docs/TauCeti/Algebra/Lie/Orthogonal/TypeB/SpinCarrier/FixedPoints.html#TauCeti.TypeBSpinCarrier.pointsMulEquivFixedSubgroupFrobenius)). These remain type-specific: there is still no uniform pinned Chevalley–Demazure construction or pinned isomorphism theorem.
