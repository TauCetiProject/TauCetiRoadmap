...
<!--tauceti-progress:v1 {"from_sha":"93386bc8ad670c449a461ad503cab6b55646542e","prs":[6493,7802,7818,7857,7936,7962,8005,8024,8036,8042,8057,8066,8067,8082,8097,8108,8113,8186,8202,8239,8243,8244,8245,8258,8263,8266,8269,8304,8310,8323,8356,8362,8363,8365,8366,8372,8414,8434,8438,8442,8466,8471,8480,8493,8496,8511,8513,8515,8532,8538,8544,8556,8561,8578,8593,8608,8614,8647,8676,8679,8690,8695,8708,8720,8722,8744,8746,8750,8765,8767,8771,8781,8784,8795,8803,8806,8814,8827,8828,8876,8891,8892,8893,8895,8901,8905,8931,8934,8944,9000,9001,9002,9006,9026,9067,9087,9088],"roadmap":"RepresentationTheory","to_sha":"de52a34770e6b94396f1feed7c1d5a562572096f"}-->
## RepresentationTheory: 2026-09-21 to 2026-09-26 (`93386bc` to `de52a34`)

The Clifford correspondence is now surjective: over an algebraically closed field of characteristic zero, every irreducible representation lying over a chosen normal-subgroup constituent [comes by induction from its inertia group](https://taucetiproject.github.io/TauCeti/docs/TauCeti/RepresentationTheory/Induction/Clifford/Surjectivity.html#FDRep.exists_simple_liesOver_inertia_nonempty_iso_indFDRep). Together with the earlier irreducibility and injectivity theorems, this gives the correspondence in that setting.

On the Ado–Iwasawa side, every element of a finite-dimensional Lie algebra in characteristic p now has a [central p-polynomial](https://taucetiproject.github.io/TauCeti/docs/TauCeti/Algebra/Lie/UniversalEnveloping/PCenter.html#TauCeti.UniversalEnvelopingAlgebra.exists_pCentralPolynomial) in its enveloping algebra; the enveloping algebra is also [left Noetherian](https://taucetiproject.github.io/TauCeti/docs/TauCeti/Algebra/Lie/UniversalEnveloping/PBW/Noetherian.html#TauCeti.UniversalEnvelopingAlgebra.isNoetherianRing_universalEnvelopingAlgebra) over a field. These are inputs to the finite-quotient argument, which has not been assembled.

Source-reflection composites now [preserve indecomposability and calculate dimension vectors](https://taucetiproject.github.io/TauCeti/docs/TauCeti/RepresentationTheory/Quiver/Reflection/Source/Composite.html#TauCeti.indecomposable_and_dimVector_sourceReflectionFunctorList) along admissible words with nonnegative intermediate vectors. This advances the reflection proof of Gabriel's theorem, but does not establish the theorem itself. For GL₂(𝔽_q), principal-series representations are [classified up to isomorphism by unordered character pairs](https://taucetiproject.github.io/TauCeti/docs/TauCeti/RepresentationTheory/CharacterTable/GL2/PrincipalSeries/Parameters.html#TauCeti.nonempty_iso_GL2PrincipalSeries_iff); the full character table remains open.
