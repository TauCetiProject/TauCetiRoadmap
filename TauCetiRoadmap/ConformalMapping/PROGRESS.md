...
<!--tauceti-progress:v1 {"from_sha":"03fcee5c26082d455072bee2d3044ce5bec908cd","prs":[2092,2660,2679,2698,3131,3147,3155,3156,3408,3426,3813,3855,3957,4002,4087,4151,4168,4576,4638,4701,4778,5003,5403,5497,5599,5653,5866,5895],"roadmap":"ConformalMapping","to_sha":"d8476fa9f4c2cec35cabffce100e7c2e75966e6c"}-->
## ConformalMapping: 2026-08-10 to 2026-09-09 (`03fcee5` to `d8476fa`)

The Carathéodory boundary correspondence reached its Jordan-domain milestone: the Riemann map of a bounded Jordan domain now extends to a homeomorphism of the closed disc with the domain closure ([`TauCeti.exists_homeomorph_closedBall_closure_of_isJordanCurve_frontier`](https://taucetiproject.github.io/TauCeti/docs/TauCeti/Analysis/Complex/Conformal/Jordan/Approach.html#TauCeti.exists_homeomorph_closedBall_closure_of_isJordanCurve_frontier)). The proof first obtains the continuous extension by making image neighbourhoods of boundary crosscuts arbitrarily small, then gets boundary injectivity from the local preconnectedness of approach regions in a Jordan domain.

Schwarz–Christoffel theory has consequently begun. The normalized Schwarz–Christoffel primitive is holomorphic and conformal on the upper half-plane ([`TauCeti.schwarzChristoffelPrimitive`](https://taucetiproject.github.io/TauCeti/docs/TauCeti/Analysis/Complex/Conformal/SchwarzChristoffel/Primitive.html#TauCeti.schwarzChristoffelPrimitive)); on a real interval free of active prevertices it has injective, collinear boundary values ([`TauCeti.exists_tendsto_schwarzChristoffelPrimitive_injOn_collinear`](https://taucetiproject.github.io/TauCeti/docs/TauCeti/Analysis/Complex/Conformal/SchwarzChristoffel/Edge.html#TauCeti.exists_tendsto_schwarzChristoffelPrimitive_injOn_collinear)), and at a finite prevertex it converges to the associated vertex ([`TauCeti.tendsto_schwarzChristoffelPrimitive`](https://taucetiproject.github.io/TauCeti/docs/TauCeti/Analysis/Complex/Conformal/SchwarzChristoffel/Vertex.html#TauCeti.tendsto_schwarzChristoffelPrimitive)). This is not yet the full formula: global injectivity and identification of the image with a prescribed polygon are not established here.
