...
the same Tau Ceti revision as the active roadmaps, so a discharged file continues to certify that
the current library realizes its archived statements. If a Tau Ceti API change breaks such a
